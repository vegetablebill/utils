...
class StringBand {
	...
	/**
	 * Creates an empty <code>StringBand</code> with provided capacity. Capacity
	 * refers to internal string array (i.e. number of joins) and not the total
	 * string size.
	 */
	...
	/**
	 * Appends a character. This is <b>not</b> efficient as in
	 * <code>StringBuilder</code>, since new string is created.
	 */
	...
	/**
	 * Appends string representation of an object. If <code>null</code>, the
	 * <code>'null'</code> string will be appended.
	 */
	...
	/**
	 * Returns char at given position. This method is <b>not</b> fast as it
	 * calculates the right string array element and the offset!
	 */
